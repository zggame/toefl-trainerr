...
export default function AttemptReviewPage() {
  ...
  return (
    <div>
      {/* Header */}
      <div className="flex items-center gap-3 px-3" style={{ marginBottom: '12px' }}>
        <button
          onClick={() => router.push('/toefl/history')}
      ...
      {/* Meta Info */}
      <div className="flex items-center gap-3 flex-wrap px-3" style={{ marginBottom: '12px' }}>
        <div 
      ...
      {attempt.errors?.length > 0 && (
        <div className="px-3" style={{ display: 'flex', flexWrap: 'wrap', gap: '8px' }}>
      ...
      {/* Actions */}
      <div className="px-3" style={{ display: 'flex', gap: '12px', marginTop: '4px' }}>
        <Button 
          variant="secondary" 
          className="flex-1"
